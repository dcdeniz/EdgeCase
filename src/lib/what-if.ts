...
export const scenarios: Scenario[] = [
  {
    ...
    label: "Stop smoking",
    overrides: { substances: 100 },
    touches: ["substances"],
    note: "This projects the score after removing current and cumulative smoking exposure. It does not predict how quickly a semen parameter would change.",
  },
  {
    id: "cut-alcohol",
    question: "What if I cut down to under 7 units a week?",
    label: "Cut alcohol",
    overrides: { substances: 92 },
    touches: ["substances"],
  },
  {
    id: "sleep-8h",
  ...
  },
  {
    ...
    question: "What if my metabolic and energy-balance factors were in a supportive range?",
    label: "Metabolic support",
    overrides: { metabolic: 95 },
    touches: ["metabolic"],
  },
  {
    id: "reduce-heat",
    question: "What if I reduced recurrent heat exposure and had no recent fever?",
    label: "Reduce heat",
    overrides: { heat: 95 },
    touches: ["heat"],
  },
  {
    id: "reduce-exposure",
    question: "What if I reduced occupational and air-pollution exposure?",
    label: "Reduce exposure",
    overrides: { environment: 95 },
    touches: ["environment"],
  },
  {
    id: "mediterranean",
...
export function matchScenario(text: string): Scenario | null {
  ...
  const table: Array<[string[], string]> = [
    ...
    [["obesity", "waist", "metabolic", "insulin", "diabetes", "weight loss", "energy restriction"], "metabolic-support"],
    [["heat", "fever", "sauna", "hot tub"], "reduce-heat"],
    [["lead", "pesticide", "solvent", "radiation", "pollution", "air quality"], "reduce-exposure"],
